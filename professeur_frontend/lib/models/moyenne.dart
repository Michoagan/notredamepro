class Moyenne {
  ...
  factory Moyenne.fromJson(Map<String, dynamic> json) {
    return Moyenne(
      ...
      // Backend envoie parfois "moyenne_trimestre" (sans 'ielle')
      moyenneTrimestrielle: _toDouble(
        json['moyenne_trimestrielle'] ?? json['moyenne_trimestre'],
      ),
      coefficient:          json['coefficient'] is num
          ? (json['coefficient'] as num).toInt()
          : null,
